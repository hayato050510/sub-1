...
<html>
    <head>
        ...
        <title>【無料】日本一当たる!? 占いアプリとは！</title>
        <link href="{{ secure_asset('css/uranai.css') }}" rel="stylesheet">
        <link href="https://use.fontawesome.com/releases/v5.6.1/css/all.css" rel="stylesheet">
    </head>
    <body>
        <header>
            <a href="https://preaf.jp/pa.do?s=v04031&o=46779&guid=ON" target="_blank"><img src="{{ asset('image/uranai_1.jpg') }}"></img></a>
            <div class="header-sub">
                <h2>抱える悩みを<br>多角面から診断・分析！</h2>
            </div>
            <div class="button">
                <a href="https://preaf.jp/pa.do?s=v04031&o=46779&guid=ON" target="_blank" class="btn-square-shadow"><i class="fab fa-apple"></i> 公式AppStoreはコチラ <i class="fas fa-external-link-alt"></i></a>
                <p><i class="far fa-hand-point-up"></i> 心理テスト感覚で気軽に始めよう！</p>
            </div>
            ...
            <!--<br>-->
            <br>
            <a href="https://preaf.jp/pa.do?s=v04031&o=46779&guid=ON" target="_blank"><img src="{{ asset('image/uranai_2.jpg') }}"></img></a>
            <div class="header-sub">
        ...
        <!--<div class="header-sub">-->
        <!--    <h2>抱える悩みを多角面から診断・分析！<br><span>日本一の呼び声高い</span>占い師集団！</h2>-->
        ...
        <!--<img src="{{ asset('image/uranai_4.jpg') }}"></img>-->
        <!--<br>-->
        <!--<br>-->
        <!--<br>-->
        <!--<br>-->
