...
<html>
    ...
    <body>
        <header>
            <img src="{{ asset('image/time_11.jpg') }}"></img>
        </header>
        ...
        <div class="big-body">
            <div class="body-top">
                ...
                <a href="https://a-trade.jp/redirect/charin?media=G16531" target="_blank"><img src="https://trading-ad.net/a-trade/banner/charin_600x500_jikyu_ss114_main.png" class="wide"></a>
            ...
            <div class="big-body-main">
                <div class="body-main">
                    <h1>もう普通のバイトは遅れてる!?<br>都内で話題の有名雑誌にも掲載された自宅スキマバイトって何？</h1>
                    <p>2020年07月11日12:03</p>
                </div>
                ...
                <div class="body-main-3">
                    ...
                    <!--<br>-->
                    <h3>報酬は嬉しい翌日支払い！</h3>
                    <!--<img src="{{ asset('image/sukiJob_4.jpg') }}"></img>-->
                    <img src="{{ asset('image/gf_2.jpg') }}"></img>
                    <br>
                    <!--<br>-->
                    <h3>巷で話題、チャリンが選ばれる理由とは？</h3>
                    <!--<img src="{{ asset('image/sukiJob_5.jpg') }}"></img>-->
                    ...
                    <!--ボタン-->
                    <a href="https://a-trade.jp/redirect/charin?media=G16531" target="_blank" class="btn-square-shadow"><i class="fab fa-apple"></i> 公式ページはコチラ <i class="fas fa-arrow-circle-right"></i></a>
                    ...
                    <p>※リンク切れの場合は、新規応募を停止しています。ご理解下さい。</p>
                    <br>
                </div>
            </div>
        ...
        <footer>
            <a href="https://a-trade.jp/redirect/charin?media=G16531" target="_blank"><img src="{{ asset('image/time_footer.jpg') }}"></img></a>
        </footer>
    </body>
</html>